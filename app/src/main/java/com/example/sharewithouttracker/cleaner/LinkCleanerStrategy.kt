...
//import android.content.Context
//import android.util.Log
//import android.webkit.WebView // 新增 import
//
//data class Link(val source: String, val url: String, val title: String?)
//
//interface LinkCleanerStrategy {
...
//
//    // 修改为 suspend 函数
//    suspend fun processText(context: Context, text: String, webView: WebView?): Link? {
//        val logTag="DebugTag"
//        Log.d(logTag, "processText")
//        for (strategy in strategies) {
//            if (strategy.isMatch(text)) {
//                val cleanedUrl = strategy.clean(context, text) ?: return null
//                Log.d(logTag, "cleanedUrl: $cleanedUrl")
//                val source = strategy.getSource(context, text) ?: return null
